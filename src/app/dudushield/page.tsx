...
export default function DuduShieldPage() {
  useEffect(() => {
    ...
    meta.content = 'DuduShield™ — Sistema de proteção profissional integrado em todos os sites do DuduStudio.'
  ...
  return (
    <div style={{ background: '#0a0a0a', color: '#ededed', minHeight: '100vh', fontFamily: 'var(--font-body, Manrope, sans-serif)' }}>
      ...
      {/* PROBLEMAS */}
      <section style={{ padding: '4rem 2rem', background: '#111111' }}>
      ...
      <section style={{ padding: '6rem 2rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#a1a1a1', fontSize: '1rem', lineHeight: 1.75 }}>
          ...
          {[
            {
              ...
              desc: 'Bloqueio automático de tentativas abusivas nos botões de contato. Rate limiting com fingerprint de dispositivo.',
            },
            {
              icon: '🛡️',
              title: 'Bloqueio de ataques',
              desc: 'Proteção contra XSS, clickjacking e scripts maliciosos. Headers de segurança profissionais configurados.',
            },
            {
              icon: '🔐',
              title: 'Anti-cópia',
              desc: "Dificulta clonagem de páginas. Detecção de domínios não autorizados e marca d'água no código.",
            },
            {
              icon: '📊',
              title: 'Monitoramento',
              desc: 'Sistema interno detecta comportamentos suspeitos e registra eventos com fingerprint do dispositivo.',
            },
          ].map((f, i) => (
            <div
              key={i}
              style={{ padding: '2rem', background: '#0f0f0f', transition: 'background 0.2s' }}
            ...
            >
              ...
              <p style={{ color: '#a1a1a1', fontSize: '0.83rem', lineHeight: 1.65, margin: 0 }}>
                {f.desc}
              </p>
            </div>
          ))}
      ...
      {/* COMPARATIVO */}
      <section style={{ padding: '4rem 2rem 6rem', background: '#111111' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ color: '#a1a1a1', fontSize: '1rem', marginBottom: '2.5rem' }}>
